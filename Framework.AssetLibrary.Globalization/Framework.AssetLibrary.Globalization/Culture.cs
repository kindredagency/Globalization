...
namespace Framework.AssetLibrary.Globalization
{
    public class Culture
    {
        ...
        internal RegionInfo RegionInfo => CultureInfo != null ? new RegionInfo(CultureInfo.Name) : null;
        ...
        internal CultureInfo CultureInfo
        {
            get
            {
                try
                {
                    return new CultureInfo(Language.LanguageCodeTwoLetter + "-" + Country.CountryCodeTwoLetter);
                }
                catch
                {
                    return null;
        ...
        public string CountryEnglishName => RegionInfo?.EnglishName;

        /// <summary>
        /// Gets or sets the name of the country native.
        /// </summary>
        /// <value>The name of the country native.</value>
        public string CountryNativeName => RegionInfo?.NativeName;

        /// <summary>
        /// Gets or sets the currency code.
        /// </summary>
        /// <value>The currency code.</value>
        public string CurrencyCode => RegionInfo?.ISOCurrencySymbol;

        /// <summary>
        /// Gets or sets the name of the currency english.
        /// </summary>
        /// <value>The name of the currency english.</value>
        public string CurrencyEnglishName => RegionInfo?.CurrencyEnglishName;

        /// <summary>
        /// Gets or sets the name of the currency native.
        /// </summary>
        /// <value>The name of the currency native.</value>
        public string CurrencyNativeName => RegionInfo?.CurrencyNativeName;

        /// <summary>
        /// Gets or sets the currency symbol.
        /// </summary>
        /// <value>The currency symbol.</value>
        public string CurrencySymbol => RegionInfo?.CurrencySymbol;
        ...
        public bool IsUnKnown => CultureInfo?.Name.Contains("Unknown Locale") ?? true;
    }
}
